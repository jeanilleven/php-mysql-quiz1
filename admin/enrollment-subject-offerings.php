    ...
    <body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="enrollment-students.php">Student Enrollment</a>
      ...
      <div class="container" style="margin-top: 20px;">
          <div class="row">
            ...
            <div class="col-lg-6">
                <button style="float:right;"type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-subject-offering-modal">
